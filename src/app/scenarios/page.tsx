      ...
      <main className="min-h-screen bg-[#0a0a0a] text-white ml-64 p-8">
        <div className="mx-auto max-w-7xl">
          <div className="flex items-start justify-between gap-6">
            <div>
              <p className="text-xs text-zinc-500">SCENARIO GENERATOR</p>
              ...
              <div className="mt-6 flex gap-2">
                {[10, 25, 50].map((amount) => (
                  <button
                    ...
                    disabled={generating}
                    className="rounded-lg border border-zinc-800 px-4 py-2 text-sm hover:bg-zinc-900 disabled:opacity-40"
                  >
                    Generate {amount}
                  </button>
                ))}
                    ...
                    <tbody>
                      ...
                      {!filtered.length && !loading && (
                        <tr>
                          <td
                            colSpan={6}
                            className="p-10 text-center text-sm text-zinc-600"
                          >
